...
def backward():
    ...
    data = Data(config.voc_root_dir, config.voc_dir_ls, "./data/voc.names", class_num, config.batch_size, config.voc_anchors, config.data_augment, config.width, config.height)
